...
* Lots of tests.  The whole protocol isn't there yet, but "this test":http://github.com/AndrewO/classy_cas/tree/master/test/protocol/service_ticket_test.rb is a good start on an executable spec for CAS 1.0/2.0.

h2. What's Missing

* Proxy authentication.
* Logout support.
* Plugable authentication stores.  I'm thining of "Warden":http://github.com/hassox/warden.  Any better ideas?
